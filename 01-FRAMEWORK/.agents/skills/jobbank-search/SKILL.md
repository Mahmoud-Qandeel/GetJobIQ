...
allowed-tools: Bash(bun run 01-FRAMEWORK/.agents/skills/jobbank-search/cli/src/cli.ts *)
---
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobbank-search/cli/src/cli.ts search [flags]
```
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobbank-search/cli/src/cli.ts detail <id> [--format json|plain]
```
...
bun run 01-FRAMEWORK/.agents/skills/jobbank-search/cli/src/cli.ts search \
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobbank-search/cli/src/cli.ts detail 1234567 --format plain
```
