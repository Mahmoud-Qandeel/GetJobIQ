...
allowed-tools: Bash(bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts *)
---
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts search [flags]
```
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts detail <jobAdId> [--format json|plain]
```
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts occupations --search-string <text> [--per-page <n>]
```
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts suggestions --query <text> [--limit <n>]
```
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts suggestions --query "syge"
bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts occupations --search-string "sygeplejerske"
```
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts search \
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts detail 9ef43bce-d82b-4ea1-a098-7ff6520f99be --format plain
```
...
```bash
bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts suggestions --query "ingeniør" --limit 5
bun run 01-FRAMEWORK/.agents/skills/jobnet-search/cli/src/cli.ts occupations --search-string "lærer" --per-page 5
```
