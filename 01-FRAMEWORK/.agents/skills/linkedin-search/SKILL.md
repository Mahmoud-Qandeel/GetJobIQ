...
allowed-tools: Bash(bun run 01-FRAMEWORK/.agents/skills/linkedin-search/cli/src/cli.ts *)
---
...
```bash
bun run 01-FRAMEWORK/.agents/skills/linkedin-search/cli/src/cli.ts search --location "<place>" [flags]
```
...
```bash
bun run 01-FRAMEWORK/.agents/skills/linkedin-search/cli/src/cli.ts detail <id|url> [--format json|plain]
```
...
bun run 01-FRAMEWORK/.agents/skills/linkedin-search/cli/src/cli.ts search -q "data engineer" -l "Bengaluru, Karnataka, India" --jobage 30 --format table

# Product manager roles in Berlin, remote
bun run 01-FRAMEWORK/.agents/skills/linkedin-search/cli/src/cli.ts search -q "product manager" -l "Berlin, Germany" --remote remote --format table

# Any role, fully remote
bun run 01-FRAMEWORK/.agents/skills/linkedin-search/cli/src/cli.ts search -q "paralegal" -l "Remote" --format table

# Engineer roles, remote, posted in the last 30 minutes
bun run 01-FRAMEWORK/.agents/skills/linkedin-search/cli/src/cli.ts search -q "engineer" -l "Remote" --jobage-minutes 30 --format table

# Full details for a specific job
bun run 01-FRAMEWORK/.agents/skills/linkedin-search/cli/src/cli.ts detail 4426311357 --format plain
```
