...
allowed-tools: Bash(bun run 01-FRAMEWORK/.agents/skills/freehire-search/cli/src/cli.ts *)
---
...
```bash
FREEHIRE_API_URL=http://localhost:8080 bun run 01-FRAMEWORK/.agents/skills/freehire-search/cli/src/cli.ts search -q "go"
```
...
```bash
bun run 01-FRAMEWORK/.agents/skills/freehire-search/cli/src/cli.ts search [-q "<keywords>"] [facet flags]
```
...
```bash
bun run 01-FRAMEWORK/.agents/skills/freehire-search/cli/src/cli.ts detail <slug|url> [--format json|plain]
```
...
bun run 01-FRAMEWORK/.agents/skills/freehire-search/cli/src/cli.ts search -q "backend engineer" --seniority senior --limit 10 --format table

# Remote React roles in the EU
bun run 01-FRAMEWORK/.agents/skills/freehire-search/cli/src/cli.ts search -q "react" --remote remote --region eu --format table

# DevOps roles in Germany posted in the last 14 days
bun run 01-FRAMEWORK/.agents/skills/freehire-search/cli/src/cli.ts search --category devops --country DE --jobage 14 --format table

# ML/AI roles anywhere, fully remote
bun run 01-FRAMEWORK/.agents/skills/freehire-search/cli/src/cli.ts search -q "machine learning" --category ml_ai --remote remote --format table

# Descriptions as plain text instead of Markdown
bun run 01-FRAMEWORK/.agents/skills/freehire-search/cli/src/cli.ts search -q "platform engineer" --limit 5 --description-format text

# Full details for a specific job
bun run 01-FRAMEWORK/.agents/skills/freehire-search/cli/src/cli.ts detail golang-zensar-2bxu6dxm --format plain
```
