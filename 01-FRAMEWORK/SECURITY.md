...
Please report security findings privately via **[GitHub private vulnerability reporting](https://github.com/Mahmoud-Qandeel/GetJobIQ/security/advisories/new)** rather than a public issue. You will get a response within a few days, credit in the fix unless you prefer otherwise, and public disclosure coordinated with the patch.
...
- Community fork skills listed in the [forks index](https://github.com/Mahmoud-Qandeel/GetJobIQ/discussions/78) are **not** covered by this policy - review the code you copy, as the index itself says.
