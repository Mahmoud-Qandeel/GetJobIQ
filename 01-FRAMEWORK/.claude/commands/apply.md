...
- `01-FRAMEWORK/.claude/skills/job-application-assistant/03-writing-style.md`
- `01-FRAMEWORK/.claude/skills/job-application-assistant/04-job-evaluation.md`
- The master CV baseline template (`04-APPLICATIONS/cv/main_example.tex`)
- The workspace root `01-FRAMEWORK/CLAUDE.md` file (specifically the Candidate Profile section)
...
Run the full verification checklist from `01-FRAMEWORK/CLAUDE.md` now — this is the **only** verification pass in the workflow. Re-read both files once here to verify final state on disk matches your mental model after the Step 4 and Step 5 edits.

### Verification Checklist
Report pass/fail for each item in the 01-FRAMEWORK/CLAUDE.md verification checklist (factual accuracy, targeting, consistency, quality).
