...
- `documents` — deletes user-provided files from the `02-Documents/` folder only
...
>
> - **`documents`** — Deletes all files you've placed in the `02-Documents/` folder (CV PDFs, LinkedIn export, diplomas, references, pasted job postings, past applications). The folder structure and `README.md` are preserved.
>
> - **`all`** — Both of the above.
>
...
- `01-FRAMEWORK/.claude/skills/job-application-assistant/05-cv-templates.md` *(profile statements section only — framework structure is preserved)*
- `01-FRAMEWORK/.claude/skills/job-application-assistant/07-interview-prep.md` *(STAR examples and STAR candidates sections only — framework structure is preserved)*
...
Use Glob to list all files present in `02-Documents/cv/`, `02-Documents/linkedin/`, `02-Documents/diplomas/`, `02-Documents/references/`, `02-Documents/postings/`, and `02-Documents/applications/`. Present as:
...
02-Documents/linkedin/
  - [filename] or "(empty)"

02-Documents/diplomas/
  - [filename] or "(empty)"

02-Documents/references/
  - [filename] or "(empty)"

02-Documents/postings/
  - [filename] or "(empty)"

02-Documents/applications/
  - [subfolder/filename] or "(empty)"

02-Documents/README.md — NOT deleted (instructions file)
```
...
For each non-empty document subfolder, delete all files within it using Bash `rm`. Do not delete the folder itself, and do not delete `02-Documents/README.md`.

```bash
rm -f 02-Documents/cv/*
rm -f 02-Documents/linkedin/*
...
> Your candidate profile is now blank. Run `/setup` to repopulate it. The command auto-detects any files in your `02-Documents/` folder and offers to read from there; otherwise it walks you through a CV import or interactive interview.

**If documents were reset:**
> The `02-Documents/` folder is now empty. Add your career documents and run `/setup` to populate your profile. See `02-Documents/README.md` for instructions on what to put where.

**If both were reset:**
> Both your profile files and documents folder are now empty. Add documents to `02-Documents/` (or skip and use the CV import / interview path), then run `/setup`.
