...
9. **All state is personal data.** `gmail_sync/state.json`, `job_search_tracker.csv`, and `02-Documents/applications/**` are gitignored - never suggest committing them.
